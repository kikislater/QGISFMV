...
"}")
        ...
        self.versionlabel = QtWidgets.QLabel(self.menubarwidget)
        self.versionlabel.setGeometry(QtCore.QRect(0, 0, 17, 33))
...
"")
        ...
        self.actionlabel = QtWidgets.QAction(ManagerWindow)
        self.actionlabel.setObjectName("actionlabel")
        self.menuFile.addAction(self.mOpenStream)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.mOpenMPEGButton)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.mActionCreateMISBButton)
        self.menuFile.addSeparator()
        ...
        self.mOpenStream.triggered.connect(ManagerWindow.openStreamDialog)
        self.VManager.doubleClicked['QModelIndex'].connect(ManagerWindow.PlayVideoFromManager)
        self.mOpenMPEGButton.triggered.connect(ManagerWindow.openVideoFileDialog)
        self.mActionCreateMISBButton.triggered.connect(ManagerWindow.openMuiltiplexorDialog)
    ...
    def retranslateUi(self, ManagerWindow):
        ...
        self.versionlabel.setProperty("versionlabel", _translate("ManagerWindow", "v 1.10"))
        ...
        self.mOpenStream.setText(_translate("ManagerWindow", "&Open Stream (experimental)"))
        self.mOpenMPEGButton.setText(_translate("ManagerWindow", "Open &Video File"))
        self.mActionCreateMISBButton.setText(_translate("ManagerWindow", "&Create MISB File"))
        self.CloseButton.setText(_translate("ManagerWindow", "C&lose"))
        self.actionlabel.setText(_translate("ManagerWindow", "label"))
